...
RETURNS TABLE (infos JSON[], favorite_id SMALLINT)
LANGUAGE plpgsql
SECURITY DEFINER AS
$func$
...
BEGIN
	...
	SELECT json_agg(json_build_object('first_name', UI.first_name, 'last_name', UI.last_name, 'phone_number', UI.phone_number, 'email', user_email)) AS infos,
	(
