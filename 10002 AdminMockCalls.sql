...
CALL store.create_extra('None', NULL, '[{"extraGroupId": 1, "displayOrder": 20}, {"extraGroupId": 2}]', 1::SMALLINT, NULL, NULL);

--group_info: {"extraGroupId": 3, "displayOrder": 20}
CALL store.modify_extra(30::SMALLINT, NULL, 0.01, '[{"extraGroupId": 3, "displayOrder": 20}]', ARRAY[1, 2]::SMALLINT[], NULL, 'No', NULL);
--
...
CALL store.modify_extra_group(10::SMALLINT, 'Test Fillings', '[{"extraId": 4, "displayOrder": 2}]', ARRAY[2, 3]::SMALLINT[], 3::SMALLINT, 
...
CALL store.create_extra_category('Cream', '[{"name": "Cream One"}, {"name": "Cream Two", "price": 1.09, "abbreviation": "C2"}]', ARRAY[10]::SMALLINT[], NULL);

CALL store.modify_extra_category(7::SMALLINT, '[{"name": "Cream Three"}]', ARRAY[1, 2]::SMALLINT[], '[{"extraId": 3, "categoryId": 6}]');
--
